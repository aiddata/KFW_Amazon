...
dta_Shp@data$TrtBin[dta_Shp@data$regend_y <= 2003] <- 1
...
dta_Shp@data$NA_check[is.na(dta_Shp@data$regend_y)] <- 1
...
pModelMean_A <- "MeanL_ ~ TrtMnt_regend_y + factor(reu_id)"
pModelMean_B <- "MeanL_ ~ TrtMnt_regend_y + MeanT_ + MeanP_ + Pop_ + MaxT_ + MaxP_ + MinT_ + MinP_  + factor(reu_id) "
pModelMean_C <- "MeanL_ ~ TrtMnt_regend_y + MeanT_ + MeanP_ + Pop_ + MaxT_ + MaxP_ + MinT_ + MinP_  + factor(reu_id) + Year"
pModelMean_D <- "MeanL_ ~ TrtMnt_regend_y + MeanT_ + MeanP_ + Pop_ + MaxT_ + MaxP_ + MinT_ + MinP_ + factor(reu_id) + Year + Post2004 + Post2004*TrtMnt_demend_y + Post2004*TrtMnt_demend_y*Road_dist + Post2004*Road_dist"
